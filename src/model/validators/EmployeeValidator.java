...
public class EmployeeValidator {
    ...
    // パスワードの必須入力チェック
    private static String _validatePassword(String password, Boolean password_duplicate_check_flag)
    {
        // パスワードを変更する場合のみ実行
        if ( (password_duplicate_check_flag) && ( (password == null) || (password.equals("")) ) )
        {
